 ...
 *
 * <p>This class <em>doesn't</em> import {@link com.hk.lua.LuaLibraryG2D}
...
public final class LuaLibraries
{
    ...
    public static final LuaLibrary<LuaLibraryUUID> UUID = new LuaLibrary<>("uuid", LuaLibraryUUID.class);
     ...
     */
    public static void importAll(@NotNull LuaInterpreter interp)
    {
     ...
     * @param interp The environment to import the libraries into
     */
    public static void importOnlyExtra(@NotNull LuaInterpreter interp)
    {
        interp.importLib(SOCKET);
        interp.importLib(HTTP);
        interp.importLib(FILESYSTEM);
        interp.importLib(UUID);
    }
     ...
     */
    public static void importAll(@NotNull LuaFactory factory)
    {
     ...
     * @param factory The environment to import the libraries into
     */
    public static void importOnlyExtra(@NotNull LuaFactory factory)
    {
        factory.addLibrary(SOCKET);
        factory.addLibrary(HTTP);
        factory.addLibrary(FILESYSTEM);
        factory.addLibrary(UUID);
    }
